...
PROMPT = ChatPromptTemplate.from_messages([
    ("system",
     """You are Lumina, an expert AI assistant that answers questions about documents.
Use ONLY the provided context to answer. Be precise and insightful.
If the answer is not in the context, say: "I couldn't find that in the document."
When relevant, mention which section your answer comes from."""),
    ("human", "Context:\n{context}\n\nQuestion:\n{question}"),
])
...
def process_pdf(uploaded_file):
    ...
    retriever = vs.as_retriever(search_type="mmr", search_kwargs={"k": 4, "fetch_k": 10, "lambda_mult": 0.5})
    os.unlink(tmp_path)
